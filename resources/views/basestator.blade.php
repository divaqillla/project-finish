...
@if (Auth::guard('suppliers')->check() && Auth::guard('suppliers')->user()->pt === 'PT DM Indonesia')
    <form id="form_dm" method="post" action="{{ route('suppanswer.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="card-body">
            <div class="card mb-4">
                <div class="card-body">
    ...
    @else
        <p>You are not authorized to access this form.</p>
    @endif
@endsection
@push('js')
