...
@section('content')
    <main>
        ...
        <a href="{{ url('/dashboardmachining') }}" class="btn btn-outline-secondary">DASHBOARD</a>
        <div class="card">
            <div class="card-body">
                <form action="" method="get" class="my-4">
                    <div class="row">
                        ...
                        <div class="col-md-2 form-group" style="margin-top:25px;">
                            ...
                            <a href="machining-history" class="btn btn-dark">Refresh</a>
                        </div>
                    </div>
                </form>
                            ...
                            @foreach ($data as $item)
                                ...
                                @foreach ($item['auditors'] as $index => $auditor)
                                    <tr>
                                        ...
                                        <td> <a href="{{ route('detailMachininggHistory', ['id_user' => $auditor->id, 'date' => $item['date']]) }}"
