...
@section('content')
    <main>
        {{-- <a href="{{ url('/checksheetsupp') }}" class="btn btn-outline-primary">+ CHECKSHEET</a> --}}
        <a href="{{ route('internal.dashboard.supplier')}}" class="btn btn-outline-secondary">DASHBOARD</a>
        <div class="card">
            <div class="card-body">
                            ...
                            @foreach ($data as $item)
                                ...
                                @foreach ($item['auditors'] as $index => $auditor)
                                    <tr>
                                        ...
                                        <td>{{ $auditor->pt }}</td>
                                        {{-- <td>{{ $auditor->supp_answers->sum('mark') / count($auditor->supp_answers) }}</td> --}}
                                        {{-- Tambahkan tombol Detail pada baris pertama --}}
                                        <td> <a href="{{ route('internal.detailSupplierHistory', ['id_user' => $auditor->id, 'date' => $item['date']]) }}"
