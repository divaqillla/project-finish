...
@section('content')
    <form id="form_painting" method="post" action="{{ route('answer.answerEmptyPainting') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
                ...
                <div class="card-body">
                 ...
                 <input type="hidden" name="auditor_id" value="{{ $auditors['auditors']->id }}">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-3" value="{{ $auditors['auditors']->name }}"
                            readonly>
                    </div>
                    <div class="form-group">
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form_painting').on('submit', function(e) {
