...
@section('content')
    <form id="form_casting" method="post" action="{{ route('answer.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="card-body">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="auditor_id" class="mb-3" style="font-size: 20px; font-weight: bold;">Information
                            <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" value="{{ $auditors['keterangan'] }}" disabled>
                    </div>
        ...
        @if ($auditors['keterangan'] == 'You\'re able to do this Audit')
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea type="text" for="note" class="form-control listener" rows="4" id="note_{{ $question->id }}"
                                                        ...
                                                        data-question-id="{{ $question->id }}" data-type="note" name="answer[{{ $question->id }}][note]"></textarea></input>
                                                </td>
                                            </tr>
                                        @else
                                            <div class="card mb-4">
                                                <div class="card-body">
                                                    ...
                                                    <input type="file" name="answer[{{ $question->id }}][image]"
                                                        class="form-control mb-4" id="image"
                                                        accept=".jpg, .jpeg, .png" placeholder="Masukkan file foto"
                                                        required>
            ...
            <button id="cancelButton" type="button" class="btn btn-secondary btn-lg btn-block">Cancel</button>
        @endif
        {{-- Card Question --}}
